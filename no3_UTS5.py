...
def main():
    ...
    # Debugging untuk cek variabel dalam label_encoder_gender.pkl
    if st.button("Cek Variabel Gender Encoder"):
        try:
            # Cek variabel dalam label_encoder_gender
            gender_labels = le_gender.classes_
            st.write("Variabel dalam Label Encoder Gender:", gender_labels)
        except Exception as e:
            st.error(f"Terjadi error saat mengecek label gender: {e}")
